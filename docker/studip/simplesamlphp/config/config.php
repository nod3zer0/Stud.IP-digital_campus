...
$config = [
    ...
    */
     ...
     */
    'secretsalt' => 'foymovftsf6d4crwsqqzzqdkxbfiqnw3',
     ...
     */
    'auth.adminpassword' => '4xnXdAErY8JD',
     ...
     */
    'session.phpsession.cookiename' => 'SimpleSamlTest',
     ...
     * syntaxes.
     */
    'store.sql.dsn'                 => 'mysql:host=db;dbname=studip_db',

    /*
     * The username and password to use when connecting to the database.
     */
    'store.sql.username' => 'studip_user',
    'store.sql.password' => 'Bup8S9rJ9uCrXGicydaQ',
