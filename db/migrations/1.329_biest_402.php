...
class Biest402 extends Migration
{
    ...
    public function up()
    {
        ...
        DBManager::get()->exec("
            ...
            ('55f3a548348dcbfdca67678588887ffd', 1, '', 'Die ist Ihr persönlicher Arbeitsplatz in Stud.IP. Hier sind Funktionen, die früher unter \"Tools\" zu finden waren, sowie neue Werkzeuge gesammelt.', 'B', 0, '', 'dispatch.php/contents/overview', '', '', 'root@localhost', 1630577268, 1630577268),
            ...
            ('55f3a548348dcbfdca67678588887ffd', 7, '', 'Lernmodule/ILIAS bietet je nach Standort Zugriff auf die Accountverwaltung von Plattformen und Werkzeugen, die an Stud.IP engedockt sind.', 'T', 0, '#layout_content UL:eq(0)  LI:eq(5)  A:eq(0)  DIV:eq(0)  IMG:eq(0)', 'dispatch.php/contents/overview', '', '', 'dozent@studip.de', 1630577268, 1630577268),
            ...
            ('d9a066071e2be43b2b51c37a9d692026', 7, '', 'Ihre hochgeladenes Lernmaterial können Sie im Bereich \"Meine Materialien\" verwalten. Nutzen Sie den Entwurfsmodus, wenn Sie Ihr Material noch nicht veröffentlichen wollen.', 'B', 0, '#nav_oer_mymaterial A:eq(0)', 'dispatch.php/oer/market', '', '', 'root@localhost', 1630577268, 1630577268),
